...
<div id="chat-popup" class="chat-popup">
    <figure class="avatar">
        <svg onclick="showChatbox()" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
...
<div id="chat-container" class="chat-container hide">
    <div class="chat-title">
        ...
        <div class="r-nav">
            <ul>
                <li>
                    <svg onclick="hideChatbox()" style="width: 20px; height: 20px; cursor: pointer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/malihu-custom-scrollbar-plugin/3.1.5/jquery.mCustomScrollbar.min.js" integrity="sha512-Yk47FuYNtuINE1w+t/KT4BQ7JaycTCcrvlSvdK/jry6Kcxqg5vN7/svVWCxZykVzzJHaxXk5T9jnFemZHSYgnw==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    ...
    <script type="text/javascript">
      ...
      function showChatbox() {
          document.getElementById('chat-popup').classList.add('hide')
      ...
      function hideChatbox() {
          ...
          document.getElementById('chat-popup').classList.remove('hide')
      }
